...
from black_cloud.settings import MEDIA_ROOT
from django.contrib.auth.models import User
from django.core.paginator import Paginator, EmptyPage
from django.contrib.auth.decorators import login_required
from django.shortcuts import render, HttpResponse, redirect
from operation_app.utils.processor import get_hashed_name
from operation_app.models import FilesRecorder, SharingRecorder
...
def download_file(request):
    ...
    filepath = os.path.join(MEDIA_ROOT, file_name)
